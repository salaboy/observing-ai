  ...
  const retroChrome = (
    <>
      ...
      <div style={{
        ...
        <a href="https://github.com/salaboy/observing-ai/tree/main/java/spring-ai-with-arconia/spring-merch-store-arconia-langsmith">Spring Merch Store (Spring AI Arconia Langsmith SemConv)</a>
